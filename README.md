...
Afin de revoir les bases de certains langages et m'améliorer en développement web, j'ai décidé de commencer le défi #100DaysOfCode. Ce défi consiste à coder tous les jours pendant au moins une heure. Ensuite, il faut push son code et partager un résumé du travail de la journée. Personellement, je partage mon aventure sur [Instagram](https://instagram.com/ana_dev_100?igshid=YmMyMTA2M2Y=). N'hésitez pas à me rejoindre !

Je ferais également un résumé de mon travail de chaque jour dans ce fichier pour garder une trâce de ma progression.

## JOUR 1 : HTML
L'aventure commence.
Aujourd'hui je me suis concentrée sur les bases du HTML. En effet, j'ai pensé qu'il était préférable de revoir les bases avant de me lancer pleinement dans ce challenge. De plus, un petit rappel ne fait de mal à personne ! ;)
...
Aujourd'hui je n'ai pas vraiment coder. Cependant, j'ai fait pas mal de recherche et j'ai continué de lire mes fiches de cours. J'ai compris ce que je devais faire pour que chaque images se modifient. Il faut que je boucle sur les éléments pour que la modification que je souhaite apporter s'applique à chacun. Petit problème, je ne maîtrise pas du tout les boucles c'est pourquoi mon travail d'aujourd'hui s'est résumé à des recherches et des tentatives de compréhension de chaque boucles. Je n'ai pas encore trouvé la boucle que je vais devoir utiliser mais j'ai peut-être une idée (je dirais la boucle for). Je me renseignerais davantage demain et tenterais des nouvelles choses! Après tout je suis là pour apprendre tout en m'amusant (si c'est possible!)
